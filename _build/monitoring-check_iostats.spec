...
Name:           monitoring-check_iostats
Version:        %{version}
Release:        %{release}
Summary:        Check disk IO usage
License:        MIT
Group:          System/Monitoring
Url:            https://github.com/joernott/monitoring-check_iostats
Source0:        monitoring-check_iostats-%{version}.tar.gz
BuildArch:      noarch
Requires:       perl
Requires:       sysstat
...
%prep
%setup -q -n monitoring-check_iostats-%{version}
